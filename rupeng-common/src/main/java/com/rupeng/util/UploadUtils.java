...
public class UploadUtils {
    ...
    public static void uploadFileByQiniuyun(File file,String accessKey,String secretKey,String bucket){
        ...
        try {
            Response res = uploadManager.put(file, file.getName(), upToken);
            if (res.isOK()) {
